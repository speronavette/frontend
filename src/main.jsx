...
const updateMetaTags = () => {
  ...
  const ogTags = [
    ...
    { 
      property: 'og:url', 
      content: isEnglishPage ? 
        'https://www.spero-navette.be/en/charleroi-airport-shuttle' : 
  ...
  alternateFrLink.setAttribute('href', 'https://www.spero-navette.be/');
  ...
  alternateEnLink.setAttribute('href', 'https://www.spero-navette.be/en/charleroi-airport-shuttle');
};
