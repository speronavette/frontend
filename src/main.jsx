...
// Cette fonction simule l'envoi des données à un service tiers comme EmailJS ou Formspree
const handleFormSubmit = async (formData) => {
  // Ici, vous pouvez intégrer un service d'envoi d'emails comme EmailJS ou Formspree
  // Exemple avec un service d'email externe:
