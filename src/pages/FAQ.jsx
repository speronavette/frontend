...
const FAQ = () => {
  ...
  // Création des données structurées (JSON-LD) pour la FAQ
  ...
  return (
    <>
      <SEO 
        title="FAQ Navette Aéroport Bruxelles Charleroi | Questions fréquentes transport"
        description="Consultez les réponses aux questions fréquentes sur notre service de navette aéroport entre votre domicile et les aéroports de Bruxelles, Charleroi et Paris."
        keywords="FAQ navette aéroport, questions transport aéroport, horaires navette Bruxelles, réservation navette Charleroi, service navette aéroportuaire, questions fréquentes transport"
      >
