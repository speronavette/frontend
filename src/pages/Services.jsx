...
function Services() {
  useEffect(() => {
    window.updatePageTitle("Services de Navette Aéroport | Bruxelles, Charleroi et autres destinations");
  }, []);
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <p className="mb-2">À l'arrivée à l'aéroport de Bruxelles : En arrivant dans le hall des arrivées sur votre droite, devant le restaurant Quick.</p>
          </div>
