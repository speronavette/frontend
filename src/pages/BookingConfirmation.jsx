  ...
  useEffect(() => {
    ...
    if (booking && window.gtag) {
      ...
      if (isRoundTrip && outboundBooking && inboundBooking) {
        conversionValue = serviceType === 'shared' 
      ...
      window.gtag('event', 'reservation_confirmee', {
        ...
        'currency': 'EUR',
        'service_type': serviceType === 'shared' ? 'Navette Partagée' : 'Navette Privée',
        'trip_type': isRoundTrip ? 'Aller-Retour' : 'Simple'
      });
      
      console.log('✅ Conversion tracked:', { value: conversionValue, id: booking?._id });
    }
  }, [singleBooking, outboundBooking, inboundBooking, isRoundTrip]);
