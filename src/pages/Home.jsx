...
function Home() {
  ...
  canonicalUrl="https://spero-navette.be/">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* ========== BANNIÈRE PROMO OPTIMISÉE ========== */}
        <div className="max-w-4xl mx-auto mb-8" style={{minHeight: '110px'}}>
          <div className="bg-yellow-50 border-2 border-yellow-400 rounded-lg shadow-sm">
            <div className="px-6 py-4 text-center">
              <div className="inline-block bg-yellow-400 text-yellow-900 font-bold text-xs px-3 py-1 rounded-full mb-2">
                ❄️ PROMO HIVER ❄️
              </div>
