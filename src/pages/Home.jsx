...
function Home() {
  ...
  // Mémoisation des données structurées
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Calculateur de prix - Élément prioritaire */}
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            />
            <TestimonialCard 
              text="Vous recherchez une navette de confiance ?? Alors n'hésitez plus... Patron plus qu'humain, d'une gentillesse et hyper arrangeant"
              author="Mélissa K. de Mettet"
            />
            <TestimonialCard 
              text="Très contents de notre prise en charge pour un transfert aller/retour sur l'aéroport de Charleroi. Les horaires étaient respectés"
