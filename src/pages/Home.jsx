          ...
          <div className="grid md:grid-cols-3 gap-8 mb-6">
            <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="flex justify-end">
                <a href="mailto:info@spero-navette.be" className="text-spero font-medium text-sm hover:underline">Demander un devis</a>
              </div>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-700">Pour les événements spéciaux, envoyez-nous un email à info@spero-navette.be avec les détails de votre demande ou appelez-nous au +32 490 197 914 pour une réservation personnalisée.</p>
              </div>
            </div>
