        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-4">"Service impeccable pour notre navette vers l'aéroport de Bruxelles. Chauffeur ponctuel et très aimable. Je recommande vivement Spero Navette !"</p>
              <p className="font-medium">- Sophie D., Wavre</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-4">"Nous utilisons régulièrement Spero Navette pour nos déplacements vers Charleroi. Service fiable, véhicules confortables et réservation facile."</p>
              <p className="font-medium">- Marc L., Namur</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-4">"Transport parfait pour notre famille vers l'aéroport de Paris CDG. Prix raisonnable, chauffeur ponctuel et très attentionné avec les enfants."</p>
              <p className="font-medium">- Julie M., Liège</p>
            </div>
          </div>
        </section>
