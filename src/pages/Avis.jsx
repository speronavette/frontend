...
const Avis = () => {
  ...
  return (
    <>
      <SEO
  title="Avis Clients 4,9/5 | 189 Témoignages Navette Aéroport | Spero Navette"
  description="Consultez les 189 avis clients Google (4,9/5) sur notre service de navette aéroport. Témoignages vérifiés de voyageurs satisfaits depuis le Hainaut."
  keywords="avis navette aéroport, témoignages clients, avis spero navette, avis google my business, navette fiable charleroi, meilleure navette belgique"
  canonicalUrl="https://www.spero-navette.be/avis"/>
