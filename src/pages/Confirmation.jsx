                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        Nous avons envoyé un email de confirmation à <span className="font-medium">{email}</span>. Notre équipe examinera votre demande et vous
                                        contactera dans les plus brefs délais pour confirmer votre réservation.
                                    </p>
