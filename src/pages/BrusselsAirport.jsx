...
const BrusselsAirport = () => {
  return (
    <>
      <SEO 
        title="Navette Aéroport Bruxelles-Zaventem | Transport depuis Charleroi et Hainaut"
        description="Service de navette aéroport Bruxelles-Zaventem depuis Charleroi et tout le Hainaut. Transport direct 24h/7j, tarifs compétitifs. ☎ 0490/19.79.14"
        keywords="navette aéroport Bruxelles, transport Zaventem, navette Charleroi Bruxelles, transfert aéroport BRU, taxi Hainaut Bruxelles"
      >
