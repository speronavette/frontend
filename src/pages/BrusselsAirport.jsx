...
import { ArrowRight, CheckCircle, Clock, MapPin, Shield, Users, Calendar, CreditCard, Phone, Star, Plane, Car, Mail, Info, ChevronDown, ChevronUp } from 'lucide-react';
...
const BrusselsAirport = () => {
  ...
  const trajets = [
    { ville: "Charleroi", distance: "55 km", tarif: "à partir de 96€", temps: "50-70 min" },
    { ville: "Nivelles", distance: "40 km", tarif: "à partir de 96€", temps: "45-60 min" },
    { ville: "Chapelle-lez-Herlaimont", distance: "50 km", tarif: "à partir de 96€", temps: "50-65 min" },
    { ville: "Sambreville", distance: "60 km", tarif: "à partir de 104€", temps: "55-75 min" },
    { ville: "La Louvière", distance: "50 km", tarif: "à partir de 96€", temps: "50-65 min" },
    { ville: "Thuin", distance: "65 km", tarif: "à partir de 104€", temps: "60-75 min" },
    { ville: "Chimay", distance: "110 km", tarif: "à partir de 151€", temps: "100-120 min" },
    { ville: "Couvin", distance: "100 km", tarif: "à partir de 139€", temps: "95-115 min" }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="mb-12">
        <div className="bg-white rounded-lg shadow-xl p-8">
          <h1 className="text-4xl font-bold text-[#E88A78] mb-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
            <a href="tel:+32490197914" className="bg-[#E88A78] text-white px-6 py-3 rounded-md hover:bg-opacity-90 transition-colors flex items-center justify-center">
              <Phone className="h-5 w-5 mr-2" />
              Réserver par téléphone : 0490 19 79 14
            </a>
            <a href="/#calculator" className="bg-white border-2 border-[#E88A78] text-[#E88A78] px-6 py-3 rounded-md hover:bg-[#E88A78]/5 transition-colors flex items-center justify-center">
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="mb-12">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-[#E88A78] mb-6 text-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="flex items-start">
                  <CheckCircle className="h-5 w-5 text-[#E88A78] mr-3 mt-0.5 flex-shrink-0" />
                  <div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead>
                  <tr className="bg-[#E88A78] text-white">
                ...
                <tbody>
                  {trajets.map((trajet, index) => (
                    <tr key={index} className={`border-b ${index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}`}>
                      ...
                      <td className="p-3 text-center font-bold text-[#E88A78]">{trajet.tarif}</td>
        ...
        <section className="mb-12 grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-[#E88A78] mb-6 flex items-center">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-lg mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="border-t border-blue-200 pt-3">
                  ...
                  <p className="text-sm text-gray-600">→ Heure de départ depuis Charleroi : <strong className="text-[#E88A78]">6h30</strong></p>
                </div>
              </div>
            </div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 text-[#E88A78] mr-2 mt-0.5 flex-shrink-0" />
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-gray-200 hover:border-[#E88A78] transition-colors">
              ...
              <div className="text-center">
                <a href="/#calculator" className="inline-block bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition-colors">
                  Calculer mon tarif
                </a>
              </div>
            </div>
            
            <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-[#E88A78] relative">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-[#E88A78] text-white text-sm font-medium px-4 py-1 rounded-full">
                  Recommandé
                </span>
              </div>
              <div className="text-center mb-6">
                <div className="bg-[#E88A78]/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Car className="h-8 w-8 text-[#E88A78]" />
                </div>
              ...
              <div className="text-center">
                <a href="/#calculator" className="inline-block bg-[#E88A78] text-white px-6 py-2 rounded-md hover:bg-opacity-90 transition-colors">
                  Calculer mon tarif
                </a>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="font-semibold text-[#E88A78]">
        ...
        <section className="mb-12">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                <div className="bg-[#E88A78] text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                  1
                </div>
              ...
              {faqs.map((faq, index) => (
                <div key={index} className="border-b pb-4">
                  <button
                    ...
                    className="w-full flex justify-between items-center text-left font-medium text-gray-900 hover:text-[#E88A78] transition-colors"
                  >
                    <span className="pr-4">{faq.question}</span>
                    {openFaq === index ? (
                      <ChevronUp className="h-5 w-5 text-[#E88A78] flex-shrink-0" />
                    ) : (
        ...
        <section className="mb-12">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
              {zones.map((zone, index) => (
                <div key={index} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                  <h3 className="font-semibold text-[#E88A78] mb-2">{zone.name}</h3>
            ...
            <div className="text-center">
              <a href="tel:+32490197914" className="inline-block bg-[#E88A78] text-white px-6 py-2 rounded-md hover:bg-opacity-90 transition-colors">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-lg border border-gray-200">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 text-[#E88A78] mr-2 mt-0.5 flex-shrink-0" />
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div>
                <h3 className="font-semibold mb-4 flex items-center">
                  <Shield className="h-5 w-5 text-[#E88A78] mr-2" />
              ...
              <div>
                <h3 className="font-semibold mb-4 flex items-center">
                  <Car className="h-5 w-5 text-[#E88A78] mr-2" />
                  Nos véhicules
                </h3>
                <p className="text-gray-700 text-sm mb-4">
              ...
              <div>
                <h3 className="font-semibold mb-4 flex items-center">
                  <Users className="h-5 w-5 text-[#E88A78] mr-2" />
                  Nos chauffeurs
                </h3>
                <p className="text-gray-700 text-sm mb-4">
        ...
        <section className="mb-8">
          <div className="bg-[#E88A78] text-white rounded-lg p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="/#calculator" className="inline-block bg-white text-[#E88A78] px-8 py-3 rounded-md hover:bg-gray-100 transition-colors font-semibold">
