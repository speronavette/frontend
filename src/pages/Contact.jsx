...
function Contact() {
  useEffect(() => {
    window.updatePageTitle("Contact | Navette Aéroport Bruxelles & Charleroi | Spero Navette");
  }, []);
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-spero mt-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <span>
                  Spero Navette SRL<br />
                  Rue de la Navette 123<br />
                  1000 Bruxelles<br />
                  Belgique
                </span>
              </p>
