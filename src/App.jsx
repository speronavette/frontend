...
// ✅ NOUVEAU : Page de confirmation pré-autorisation
const BookingPreAuthConfirmation = lazy(() => import('./pages/BookingPreAuthConfirmation'));

// Page anglaise spécifique (si elle existe)
          ...
          <main className="flex-grow px-4 sm:px-6 lg:px-8">
            <Suspense fallback={<LoadingSpinner />}>
              <Routes>
                ...
                {/* ✅ NOUVEAU : Route pour confirmation pré-autorisation */}
                <Route path="/booking-preauth-confirmation" element={<BookingPreAuthConfirmation />} />
                
                {/* Page anglaise si elle existe */}
