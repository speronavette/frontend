...
// Ajout des nouvelles pages de blog
          ...
          <nav className="bg-spero text-white p-4" aria-label="Navigation principale">
            <div className="max-w-6xl mx-auto flex justify-between items-center px-4">
              <div className="flex space-x-4">
                ...
                <Link to="/blog" className="hover:text-opacity-80">Blog</Link> {/* Ajout du lien vers le blog */}
          ...
          <footer className="bg-spero text-white py-8" id="contact">
            <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <Link to="/blog" className="block hover:text-opacity-80">Blog</Link> {/* Ajout du lien vers le blog */}
              ...
              <div>
                ...
                <p className="mt-2">
                  <span className="block">Horaires d'ouverture du bureau:</span>
