    ...
    try {
      ...
      const bookingData = {
        ...
        options: {
          ...
          other: `English Website | Route: ${formData.route1}${formData.needsReturn === 'yes' ? ` + ${formData.route2}` : ''} | Full Address: ${fullAddress} | PRE-AUTH Payment ID: ${paymentMethodId} | Booking Ref: ${bookingRef} | PaymentIntent: ${preAuthDetails.paymentIntentId} | Status: ${preAuthDetails.status} | Bags: ${formData.bags}${formData.specialRequests ? ` | Special Requests: ${formData.specialRequests}` : ''}`
        },
