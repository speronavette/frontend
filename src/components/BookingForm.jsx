...
// Données structurées pour le formulaire de réservation
...
function BookingForm() {
 ...
 const [personalInfo, setPersonalInfo] = useState({
   ...
   locality: '' // Nouveau champ pour la localité
 });
       ...
       bookingData = {
         client: {
           ...
           address: {
             ...
             locality: personalInfo.locality // Ajout de la localité
           }
         },
         journey: {
           type: 'roundTrip',
 ...
 // Calculer un titre dynamique basé sur la destination sélectionnée
 const getPageTitle = () => {
 ...
 // Définir la description en fonction des données du formulaire
       ...
       {error && (
         ...
         <section>
           ...
           <div className="grid md:grid-cols-2 gap-6">
             ...
             {/* Code postal, commune et localité - Réorganisation */}
