 ...
 const updatePrice = () => {
  ...
  if (pricesFromCalculator && formData.prices) {
    if (journeyType === 'roundTrip') {
      // Calculer les prix pour chaque trajet
     ...
     if (journeyType === 'roundTrip') {
       bookingData = {
         ...
         price: {
           ...
           outboundPrice: {
             sharedPrice: calculatePrice(personalInfo.postalCode, outboundJourney.airport, Number(personalInfo.passengers)).sharedPrice,
             privatePrice: calculatePrice(personalInfo.postalCode, outboundJourney.airport, Number(personalInfo.passengers)).privatePrice
           },
           inboundPrice: {
             sharedPrice: calculatePrice(personalInfo.postalCode, inboundJourney.airport, Number(personalInfo.passengers)).sharedPrice,
             privatePrice: calculatePrice(personalInfo.postalCode, inboundJourney.airport, Number(personalInfo.passengers)).privatePrice
           }
         },
         options: freeOptions,
